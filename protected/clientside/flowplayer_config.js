   ...
   Flowplayer with ux.Media.Flash
Flowplayer
Demo Source: flowplayer.js
 ...
 */
 ...
 (function(){
    ...
    var vizPlugin = Ext.ux.plugin && Ext.ux.plugin.VisibilityMode // && !Ext.isIE
       ...
       : {init: Ext.emptyFn};
  delete Ext.ux.plugin.VisibilityMode;
  
Demo.FlowPlayer ||

  (Demo.FlowPlayer = Ext.extend( Demo.Window, {
      ...
      initComponent: function(){
          ...
          this.items = [{
               ...
               defaults : {
                   closable: true,
                   hideMode : 'nosize',
                   plugins : null //[vizPlugin] //Give ALL tabs the visibilityMode plugin
               },
               items : {
                    xtype   : 'flashpanel',
                    id      : 'flowplaything',
          ...
          Demo.FlowPlayer.superclass.initComponent.apply(this,arguments);
        },
