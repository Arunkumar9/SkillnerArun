...
Ext.extend(Ext.layout.CarouselLayout, Ext.layout.ContainerLayout, {
    ...
    onLayout : function(ct, target){
        ...
        this.scroller.setWidth(this.container.getLayoutTarget().getWidth() - 46);
...
//			DOM Element
    ...
    scrollTo : function(pos, animate){
        this.scroller.scrollTo('left', pos, animate ? this.getScrollAnim() : false);
        if(!animate){
    ...
    getScrollWidth : function(){
        ...
        return Math.abs(this.strip.getOffsetsTo(l)[0]) + l.getWidth();
    },

    // private
    getScrollPos : function(){
        return parseInt(this.scroller.dom.scrollLeft, 10) || 0;
    },

    // private
    getScrollArea : function(){
        return parseInt(this.scroller.dom.clientWidth, 10) || 0;
    },
