...
Gadget typ 3 - katalog, jedna položka na řádku.

POZOR! pojmenování je GadgetList2 kvůli kompatibilite
...
<com:TRepeater ID="Repeater" >
	<prop:ItemTemplate>
			...
			<div class="catalogueItem">
				...
				<a href="<%# $this->Data->getLink(1) %>" class="catalogueImage g2-<%# $this->Data->uid %>">&nbsp;</a>
