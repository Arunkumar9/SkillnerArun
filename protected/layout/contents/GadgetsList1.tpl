...
<div class="gadgetsContainer">
    ...
    <com:TRepeater ID="Repeater" >
        <prop:ItemTemplate>
            <a href="<%# $this->Data->getLink(1) %>" class="gadget <%# $this->Data->getGsel() %>"><span><%# ($this->Data->FirstImage)?$this->Data->name:$this->Data->description %></span></a>
        </prop:ItemTemplate>
