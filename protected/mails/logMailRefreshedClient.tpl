...
<com:THead >
	<prop:Title>
		Svět zdraví - Změny u stávajícího klienta / zobrazena KNT analýza / pobočka: <%= $this->Page->CustomData->Branch->name %>
	</prop:Title>
	<com:TStyleSheet>
...
/>
				...
				<h1>Svět zdraví<sup>®</sup> - změny u stávajícího klienta - zobrazena KNT analýza</h1>
...
<p>                Datum a čas vytvoření: <%= $this->Page->CustomData->CreatedAsDateF %></p>

<p>				Datum a čas úpravy: <%= $this->Page->CustomData->UpdatedAsDateTimeF %></p>
