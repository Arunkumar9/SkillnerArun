...
Ext.define('CHAT.view.TinyMCETextAreaWindowManager', {
 // extend: 'tinymce.WindowManager',
  ...
  constructor: function(cfg) {
    CHAT.view.TinyMCETextAreaWindowManager.superclass.constructor.call(this, cfg.editor);
...
Ext.define('CHAT.view.TinyMCETextArea', {
  ...
  */
  ...
  initEditor: function(){
    ...
    me.tinyMCEConfig.onchange_callback = function(ed) {
      ...
      me.contentValue = newval;	//Here we get the new content value of TinyMCE
      ed.save();
    ...
    me.tinyMCEConfig.setup = function(ed) {
      ...
      ed.onExecCommand.add(function(ed, cmd, ui, val) {
        ...
        if(fullscreen_ed)
        {
          fullscreen_ed.windowManager = Ext.create('CHAT.view.TinyMCETextAreaWindowManager', {
            control: me,
      ...
      ed.onInit.add(function(eTextAread) {
    	  if( !me.wysiwygIntialized ){
		  me.wysiwygIntialized = true;
		  me.fireEvent('editorinitialize',me);
	  }
        me.wysiwygIntialized = true;
      ...
      ed.onPostRender.add(function(ed, controlManager) {
        ed.windowManager = Ext.create('CHAT.view.TinyMCETextAreaWindowManager', {
          control: me,
          editor: ed
        });     
      });
