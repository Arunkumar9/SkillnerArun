	...
	init : function(ed) {
		...
		if (n.nodeName == 'IMG') {
			...
			nl.insert.value = ed.getLang('update');
                        ...
                        if (/fresh-highslide/.test(dom.getAttrib(n, 'class')))
                                nl.hislidecheck.checked = true;
                        else
                                nl.hislidecheck.checked = false;
	...
	insertAndClose : function() {
		...
		if (f.onmousemovecheck.checked) {
			...
			if (nl.onmouseoutsrc.value)
                ...
                if (f.hislidecheck.checked && !/fresh-highslide/.test(args['class'])) {
                    var cls = args['class']+' ' + 'fresh-highslide'
                    cls.trim();
                    args['class'] = cls;
