/**
 * $Id: editor_template.js 2348 2013-12-20 10:20:54Z arun $
 *
 * @author Moxiecode
...
(function() {
	...
	tinymce.create('tinymce.themes.ExtJSTheme', {
...
*/
		...
		_addToolbars : function(c, o) {
			...
			n = DOM.add( 
					DOM.add( 
						DOM.add( c, 'tr' ), 
						"div", { "class": "mceToolbar" } 
					), 
					'td', {'class' : 'mceToolbar', align : s.theme_advanced_toolbar_align}
				);
	...
	tinymce.ThemeManager.add('extjs', tinymce.themes.AdvancedTheme);
}());