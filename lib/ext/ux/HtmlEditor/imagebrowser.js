...
*/  /*
var form = new Ext.form.BasicForm({renderTo: document.body});
  
*///form.baseParams =  { cmd: 'upload', json:'fileProvider' };
	...
	stateful: false,
  	items: [{
		...
		stateful: false,
  		...
  		//baseParams: { path: 'root/', cmd: 'upload' }
  	},{
  		layout: 'fit',
  		region: 'center',
		minWidth: 514,
...
Ext.reg('uximagebrowser','Ext.ux.ImageBrowser');
