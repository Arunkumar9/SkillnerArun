 ...
 */
Ext.namespace('FD');
FD.CreditsWindow = function(field){
...
FD.creditTrigger = function(config) {
    Ext.applyIf(config,{
     editable: false,
     triggerClass: 'money-trigger',
     align: 'right'
   });
   FD.creditTrigger.superclass.constructor.call(this,config);
}
Ext.extend(FD.creditTrigger,Ext.form.TriggerField,{
    initComponent: function() {
        this.onTriggerClick = FD.CreditsWindow.createDelegate(FD.CreditsWindow,[this]);
    }
});

Ext.reg('credit',FD.creditTrigger);
