    ...
    init : function(){
        ...
        this.trayPanel = new Ext.ux.TrayPanel({
                       ...
                       // stateId: 'ext-task-tray',
                        data: Fresh.User,
                        tpl: '<span style="float:right;" class="x-btn x-btn-text user">{Name} <b>{Version}</b></span> ',
                        //html: '<span style="float:right;" class="x-btn x-btn-text user">'+Fresh.User.Name+Fresh.User.Version+'</span> ',
                        minWidth: 75,
                        region:'east',
                        split: false,
                        width: 100
