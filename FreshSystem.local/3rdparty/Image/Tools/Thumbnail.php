 ...
 *              BSD License
 * @version     CVS: $Id: Thumbnail.php 2348 2013-12-20 10:20:54Z arun $
...
define('IMAGE_TOOLS_THUMBNAIL_METHOD_SCALE_FIT', 3);
...
class Image_Tools_Thumbnail extends Image_Tools
{
    ...
    var $options = array(
        ...
        'height'  => 100,
        'percent' => 0,
        'method'  => IMAGE_TOOLS_THUMBNAIL_METHOD_SCALE_FIT,
       ...
       if (!Image_Tools::isGDImageResource($this->resultImage)) {
        ...
        if ($this->options['method'] == IMAGE_TOOLS_THUMBNAIL_METHOD_CROP) {
            ...
            if ($this->options['percent']) {
                ...
                } elseif ( $this->options['method'] == IMAGE_TOOLS_THUMBNAIL_METHOD_SCALE_FIT ) {
                    $Ww = $width / $W;
                    $Hh = $height / $H;
                    if ( $Ww*$H > $height ) {
                        $width = floor($W * $Hh);
