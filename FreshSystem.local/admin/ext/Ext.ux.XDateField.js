...
Ext.ux.form.XDateField = Ext.extend(Ext.form.DateField, {
    ...
    ,parseDate : function(value){
        ...
        if (value == '0000-00-00' || value === 0){ //&& value.match(/^00/)) {

            value = null;

        }

        return Ext.ux.form.XDateField.superclass.parseDate.call(this, value);

    },
    onTriggerClick : function(){
        Ext.ux.form.XDateField.superclass.onTriggerClick.apply(this,arguments);
        if(this.disabled){
            return;
        }
        if (this.pickerStartDate)
            this.menu.picker.setValue(this.getValue() || this.parseDate(this.pickerStartDade));
        else
 ...
 */
Ext.ux.form.XDateTime = Ext.extend(Ext.form.Field, {
    /**
    ...
    ,initComponent:function() {
        ...
        Ext.ux.form.XDateTime.superclass.initComponent.call(this);
    ...
    ,onRender:function(ct, position) {
        ...
        Ext.ux.form.XDateTime.superclass.onRender.call(this, ct, position);
...
//            this.dateValue.setDate(d.getDate());
    ...
    ,renderer: function(field) {
        var format = field.editor.dateFormat || Ext.ux.form.XDateTime.prototype.dateFormat;
        format += ' ' + (field.editor.timeFormat || Ext.ux.form.XDateTime.prototype.timeFormat);
...
// register xtype
Ext.reg('xxdatetime', Ext.ux.form.XDateTime);
// e/o file 
// eo file 