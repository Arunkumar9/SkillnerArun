 ...
 * @version   $Id: Ext.ux.MetaForm.js 2348 2013-12-20 10:20:54Z arun $
 *
...
Ext.ux.MetaForm = Ext.extend(Ext.FormPanel, {
    ...
    ,beforeAction:function(form, action) {
        if (action.type == 'submit') {
			// this.form.beforeAction(form, action); 
		}
		else {
    ...
    ,onMetaChange:function(form, meta) {
        ...
        // declare varables
        var panel,columns, colIndex, tabIndex, ignore = {};
...
*/        
		this.add(new Ext.Panel((function(){
                this.columnCount = meta.formConfig ? meta.formConfig.columnCount || this.columnCount : this.columnCount;
                return Ext.apply({}, meta.formConfig || {}, {
                    autoHeight:true
                    ,border:false
