 ...
 * @version   $Id: Ext.ux.MsgBus.js 2348 2013-12-20 10:20:54Z arun $
 *
		...
		Ext.applyIf(this.cmp, {
			 ...
			 */
			 subscribe:function(subject, config) {
				Fresh.console.log('BUS SUBSCRIBE: '+subject);
			...
			,publish:function(subject, message) {
				Fresh.console.log('BUS PUBlISH: '+subject);
                                Fresh.console.log(message);
