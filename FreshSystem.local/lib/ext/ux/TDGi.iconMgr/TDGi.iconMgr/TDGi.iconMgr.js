...
Ext.ux.TDGi.iconMgr = function(iconName) {
	...
	return  {
		init : function() {
			...
			styleSheet = Ext.util.CSS.createStyleSheet('/* TDG-i.iconMgr stylesheet */\n', styleSheetId);
	...
	return  {
		...
		show : function() {
			...
			if (! this.dataFilePath) {
				Ext.MesageBox.alert('Error', 'Please set the path! E.g. Ext.ux.TDGi.iconMgr.setPath("TDGi.icons").show();');
				return;
			}
			win.show();
		},
