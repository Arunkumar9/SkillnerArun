...
Ext.ux.Plugin.LiteRemoteComponent = function (config){
    ...
    var callback = function(res){ 
		this.container.add(Ext.ComponentMgr.create(Ext.decode.call(defaultScope,res.responseText), defaultType)).show();
...
Ext.ux.Plugin.RemoteComponent = function (config){
	...
	*/
	...
	var decodeScope = config.scope || this;
    ...
    */
    var callback = function(res){ 
        var JSON = Ext.decode.call(decodeScope,res.responseText);
