// $Id: Field.js 2348 2013-12-20 10:20:54Z arun $
...
Ext.extend(Ext.ux.netbox.core.Field,Ext.util.Observable,/** @scope Ext.ux.netbox.core.Field.prototype */
{
  ...
  createEditor: function(operatorId){
    ...
    if(!this.isAvailableValuesAvailable()){
      ...
      editor=new Ext.ux.netbox.core.AvailableValuesEditor(this.getAvailableValues(),this.isStoreRemote(),this.isForceReload(),config);
    }
    return editor;
  },
